...
Public Class StockCReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wall_Project1.StockCReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockCReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockCReport = New StockCReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
